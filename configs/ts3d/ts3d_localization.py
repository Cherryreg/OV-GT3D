...
model = dict(
    ...
    text_features_file = 'data/text_features/1_class_text_features_prompt.pt',
    train_cfg=dict(),
    test_cfg=dict(
...
data_root_train = 'data/scannet/scannet_seen10/'
data_root_val = 'data/scannet/scannet_all/'
