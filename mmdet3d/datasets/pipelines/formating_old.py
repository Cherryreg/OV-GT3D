...
class DefaultFormatBundle(object):
    ...
    def __call__(self, results):
        ...
        for key in [
                ...
                'pts_semantic_mask', 'centers2d', 'depths', 'feat_3d', 'mask_chunk', 'mask_ind',
...
class Collect3D(object):
    ...
    def __init__(
        ...
        meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                   ...
                   'affine_aug', 'feat_3d', 'mask_chunk', 'mask_ind', 'img_calib', 
                   'gt_from_image_mask', 'image', 'intrinsics', 'extrinsics', 'img_info')):
        self.keys = keys
    ...
    def __call__(self, results):
        ...
        if self.with_gt:
            ...
            if 'gt_bboxes_3d_mask' in results:
                ...
                #########'gt_from_image_mask', 'image', 'intrinsics', 'extrinsics'
                if 'gt_from_image_mask' in results:
                    results['gt_from_image_mask'] = results['gt_from_image_mask'][gt_bboxes_3d_mask]
                if 'image' in results:
                    results['image'] = results['image'][gt_bboxes_3d_mask]
                if 'extrinsics' in results:
                    results['extrinsics'] = results['extrinsics'][gt_bboxes_3d_mask]
                #####################################################################
