...
def main():
    ...
    TARGET_DIR = "./scannet/scannet_all/gt_images" # Replace it with the path to output path\
    BBOX_PATH = "./scannet/scannet_all/scannet_instance_data"  #Replace it with the path to OWP_scannet_all/scannet_instance_data
