...
OBJ_CLASS_IDS = np.array([3,4,5,6,7,8,12,14,34,36,9,10,16,24,33,11,38]
)   
...
def export_one_scan(scan_name,
    ...
    label_sem = osp.join(scannet_dir, scan_name,
...
def main():
    ...
    parser.add_argument(
        '--output_folder',
        default='./scannet/scannet_OIS3D/scannet_instance_data',
